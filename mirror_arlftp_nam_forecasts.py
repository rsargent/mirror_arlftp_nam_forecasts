import datetime, ftplib, getpass, mgzip, io, os, sys, traceback
...
try:
    ...
    log(f'Received Exception: >>>\n{traceback.format_exc()}<<<')
    log(f'Mirror failed due to exception.  Exiting with status 1')
    sys.exit(1)

log(f'Completed successfully.  Exiting with status 0')
sys.exit(0)
